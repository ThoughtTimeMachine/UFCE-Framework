...
if __name__ == "__main__":
    # 1. The Baseline (Paper Reference)
    print("\n=== RUN 1: Baseline Verification ===")
    benchmark_ufce(4500, 639058)
    
    # 2. The Stress Test (10 Billion)
    print("\n=== RUN 2: 10 Billion Point Stress Test ===")
    benchmark_ufce(10000, 1000000)

    # 3. The "OMFG" Test (1 Terabyte Equivalent)
    # Target: 125 Billion Points
    # Math: 125,000 spatial x 1,000,000 temporal = 125,000,000,000 points
    # Traditional RAM Requirement: 125B * 8 bytes = 1,000 GB (1 TB)
    print("\n=== RUN 3: The 1 Terabyte Challenge (125 Billion Points) ===")
    print("...This typically requires a High-Performance Computing Cluster...")
    benchmark_ufce(125000, 1000000)